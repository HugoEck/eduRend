...
struct Material
{
	vec3f AmbientColour = { 0.0f, 0.0f, 0.3f };   // Ambient color: Dark blue
	vec3f DiffuseColour = { 0.0f, 0.0f, 0.3f };   // Diffuse color: Dark blue
	vec3f SpecularColour = { 0.0f, 0.0f, 0.3f };  // Specular color: Light blue
