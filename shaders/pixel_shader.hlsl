...
// C//alculate the direction from the surface point to the light source
    ...
    // Calculate the diffuse lighting contribution using Lambert's cosine law
    float3 diffuseLight = diffuseTextureColor * DiffuseColour * max(0.0f, dot(normal, lightDirection));
